...
export default function Promo() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setEditId(null);
      setFormData({
        title: '', type: 'DISCOUNT', discount_percent: '', discount_amount: '', min_buy_qty: '', free_qty: '', min_buy_menu_id: '', free_menu_id: '', min_nominal: '', promo_rule: '', start_date: '', end_date: '', day_filter: 'All Days', time_filter: 'All Day', custom_start_time: '', custom_end_time: ''
      });
      fetchData();
    } catch (err) {
  ...
  return (
    <div className="p-8 space-y-8">
      <div className="flex justify-between items-center">
        ...
        <button 
          onClick={() => {
            setEditId(null);
            setFormData({
              title: '', type: 'DISCOUNT', discount_percent: '', discount_amount: '', min_buy_qty: '', free_qty: '', min_buy_menu_id: '', free_menu_id: '', min_nominal: '', promo_rule: '', start_date: '', end_date: '', day_filter: 'All Days', time_filter: 'All Day'
            });
            setShowModal(true);
          }}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {promos.map(promo => (
          <div key={promo.promo_id} className={`bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col relative ${!promo.is_active ? 'opacity-60' : ''}`}>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <form onSubmit={handleSubmit} className="p-6 overflow-y-auto flex-1 space-y-6">
              ...
              ) : formData.type === 'MIN_BUY_DISCOUNT' ? (
                <div className="grid grid-cols-2 gap-6">
                  <div>
              ...
              ) : formData.type === 'MIN_NOMINAL_FREE' ? (
              ...
              {formData.time_filter === 'Custom Time' && (
                <div className="grid grid-cols-2 gap-6">
                  <div>
