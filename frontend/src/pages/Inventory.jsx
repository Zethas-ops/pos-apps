...
function Inventory() {
  ...
  const confirmDelete = async () => {
    if (!deleteId) return;
    try {
      const { error } = await supabase.from('ingredients').delete().eq('ingredient_id', deleteId);
      if (error) throw error;
      setDeleteId(null);
      fetchInventory();
    } catch (err) {
  ...
  >
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-200 dark:bg-gray-600 border-b border-gray-200 dark:border-gray-700">
              ...
              <th className="p-4 font-bold text-gray-600 dark:text-gray-300">Unit</th>
    ...
    className="p-2 text-green-600 hover:bg-green-50 dark:bg-blue-900/30 rounded-lg transition-colors inline-flex items-center"
    title="Adjust Stock"
  >
                    <Settings2 size={20} />
                  </button>
    ...
    className="p-2 text-blue-600 hover:bg-blue-50 dark:bg-blue-900/30 rounded-lg transition-colors inline-flex items-center"
    title="Edit Detail"
  >
                    <Edit2 size={20} />
                  </button>
    ...
    className="p-2 text-red-600 hover:bg-red-50 dark:bg-blue-900/30 rounded-lg transition-colors inline-flex items-center"
    title="Delete"
  >
                    <Trash2 size={20} />
                  </button>
  ...
  >
      ...
      {deleteId && <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col">
            ...
            <div className="p-6">
              <p className="text-gray-600 dark:text-gray-300">Are you sure you want to delete this ingredient? This action cannot be undone.</p>
            </div>
