    ...
    <div className="p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredBills.map(bill => {
          const total = bill.items.reduce((sum: number, i: any) => sum + i.subtotal, 0);
          return (
            <div key={bill.bill_id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
